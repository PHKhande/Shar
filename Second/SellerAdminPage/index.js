...
window.addEventListener('DOMContentLoaded', async () => {
    try{
        let response = await axios.get("https://crudcrud.com/api/9d26443d457c4316bdeca2d9338b9cc7/productsData")
...
async function addProduct(e){
    try{
        ...
        let response = await axios.post("https://crudcrud.com/api/9d26443d457c4316bdeca2d9338b9cc7/productsData", obj)
...
function showProductdetails(obj){
    ...
    editBtn.onclick = async() => {
        try {
            ...
            await axios.delete(`https://crudcrud.com/api/9d26443d457c4316bdeca2d9338b9cc7/productsData/${obj._id}`)
